...
export default class NativeUI {
    ...
    public UpdateScaleform() {
        ...
        this._instructionalButtonsScaleform.callFunction("SET_DATA_SLOT", 0 as number, GetControlInstructionalButton(2, Control.PhoneSelect as number, false) as string, this.SelectTextLocalized as string);
        this._instructionalButtonsScaleform.callFunction("SET_DATA_SLOT", 1 as number, GetControlInstructionalButton(2, Control.PhoneCancel as number, false) as string, this.BackTextLocalized as string);
