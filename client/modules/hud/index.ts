...
class HUD {
    ...
    public displayChat(toggle: boolean) {
        if(toggle == this.chat) {
            return;
        }

        globalThis.exports.chat.toggle(toggle);
        this.chat = toggle;
    }
...
globalThis.exports('HUDDisplayChat', (toggle: boolean) => {HUDManager.displayChat(toggle)});
...
globalThis.exports('HUDHasChat', () => HUDManager.chat);
